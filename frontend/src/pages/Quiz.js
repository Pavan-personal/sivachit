...
const Quiz = () => {
  ...
  const handleTrueFalseAnswer = (answer) => {
    ...
    if (isCorrect) {
      ...
      setFeedback({
        isCorrect: false,
        message: `Incorrect! Correct answer: ${
          correctAnswerStr === "true" ? "True" : "False"
        }`,
      });
    }
  ...
  const handleShortAnswerSubmit = () => {
    ...
    const correctAnswerClean = String(currentQ.correctAnswer)
      .trim()
      .toLowerCase();
  ...
  }, [currentQuestion, questions.length, id, score, userAnswers]);
        ...
        <div className="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow">
          ...
          <div className="text-center mb-6">
            ...
            <div className="text-sm text-gray-600">
              Last attempted:{" "}
              {new Date(previousResult.attemptedAt).toLocaleDateString()}
            </div>
          </div>
              ...
              return (
                ...
                >
                  <div className="font-medium">
                    {index + 1}. {questions[index]?.question || "Question"}
                  </div>
